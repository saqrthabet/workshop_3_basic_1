...
def start_app():
    ...
    show.display(Hayat_hotel.hotel_name)# Check the General details for all hotels
...
#def Test_reservation_in_a_hotel(hotel):
    ...
    show.display(reservation.list_resevrations_for_hotel('Holydayin'))
   
#def Test_list_of_available_hotels_in_a_city(city):
    show.display("\t Test_list_of_available_hotels_in_a_city('Abu Dhabi')")
    show.display(hotel.list_hotels_in_city('Abu Dhabi'))
